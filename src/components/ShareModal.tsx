...
export default function ShareModal({
  open, onClose, title, sub, sharedWith, onChange,
}: { open: boolean; onClose: () => void; title: string; sub: string; sharedWith: string[]; onChange: (users: string[]) => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={title} sub={sub} width="440px">
