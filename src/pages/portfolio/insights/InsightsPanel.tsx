...
const toneStyle = {
  ...
  neutral: { border: "border-l-ink-300", icon: Sparkles, iconColor: "text-ink-500" },
};
...
export default function InsightsPanel({ scope, limit = 4 }: { scope?: string; limit?: number }) {
  ...
  return (
    <Card>
      <CardHeader title="Intelligence insights" sub="Generated from portfolio performance data" right={<Sparkles size={15} className="text-accent-600" />} />
