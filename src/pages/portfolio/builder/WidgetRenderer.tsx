    ...
    case "kpi": {
      ...
      return (
        <Stat
          ...
          sub={delta !== null ? `${delta >= 0 ? "+" : ""}${delta}${unit} vs ${comparisonLabel(config.comparison)}` : undefined}
      ...
      return (
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 4, right: 4, bottom: 0, left: -18 }}>
            ...
            <YAxis tick={{ fontSize: 10.5, fill: "#8a93a6" }} axisLine={false} tickLine={false} />
            <Tooltip contentStyle={{ fontSize: 12, borderRadius: 10, border: "1px solid #dde1e9" }} />
            <Area type="monotone" dataKey="value" stroke="#2563eb" strokeWidth={2} fill="#2563eb" fillOpacity={0.15} />
          </AreaChart>
        </ResponsiveContainer>
      );
    }
