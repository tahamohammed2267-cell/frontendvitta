...
export default function WidgetChrome({
  ...
  return (
    <div className={cn("relative flex h-full flex-col rounded-xl border border-ink-200 bg-white shadow-[0_1px_2px_rgba(11,14,20,0.04)]", dragging && "opacity-50 ring-2 ring-accent-600/30")}>
