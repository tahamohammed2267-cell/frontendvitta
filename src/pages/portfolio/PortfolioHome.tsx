...
export default function PortfolioHome() {
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-6">
      ...
      <Link to="/portfolio/health" className="mb-6 flex items-center gap-4 rounded-lg border border-warn-100 bg-warn-50/60 px-5 py-4 fade-up transition-colors hover:border-warn-200">
