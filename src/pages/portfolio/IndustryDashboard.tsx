    ...
    <div className="mx-auto max-w-[1200px] px-6 py-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-2 space-y-4 fade-up">
            ...
            <div className="grid grid-cols-4 gap-3">
              {driverAverages.map((d) => (
                <div key={d.label} className="rounded-lg border border-ink-100 p-3">
                  ...
                  <p className="num mt-1 break-words text-[17px] font-semibold leading-tight tracking-tight">{d.value.toLocaleString()}{d.unit}</p>
            ...
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={regionRows.map((r) => ({ name: r.region.name, revenue: r.summary.totalRevenueM }))} margin={{ top: 4, right: 4, bottom: 0, left: -18 }}>
                  ...
                  <Bar dataKey="revenue" fill="#0e5f45" radius={[4, 4, 0, 0]} barSize={36} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          ...
          <CustomDashboardsSection scope="industry" scopeId={ind.key} />
        </div>
